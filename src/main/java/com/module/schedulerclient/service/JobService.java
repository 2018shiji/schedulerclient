package com.module.schedulerclient.service;
...
import com.module.schedulerclient.repository.JobGroupMapper;
import com.module.schedulerclient.repository.JobInfoMapper;
import com.module.schedulerclient.repository.JobLogMapper;
import com.module.schedulerclient.repository.JobLogReportMapper;
import com.module.schedulerclient.util.JobUtil;
...
public class JobService {
    ...
    public PageVO<JobLogBO> selectJobLog(JobLogQuery jobLogQuery) {
        ...
        Pageable pageable = PageRequest.of(jobLogQuery.getPage(), jobLogQuery.getLimit());
        Page<JobLog> jobLogPage = jobLogMapper.findAll(pageable);
        List<JobLogBO> jobLogs = (List<JobLogBO>)jobLogPage.getContent();
