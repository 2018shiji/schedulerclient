...
import com.module.schedulerclient.model.query.UserQuery;
import com.module.schedulerclient.model.vo.PageVO;
import com.module.schedulerclient.repository.UserMapper;
import com.module.schedulerclient.util.SessionUtil;
...
public class UserService {
    ...
    public PageVO<User> selectUser(UserQuery userQuery) {
        ...
        if (userQuery != null && StringUtils.isNotBlank(userQuery.getUsername())) {
